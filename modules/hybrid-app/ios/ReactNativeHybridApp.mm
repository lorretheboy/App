...
- (void)signInToOldDot:(NSString * _Nullable)autoGeneratedLogin autoGeneratedPassword:(NSString * _Nullable)autoGeneratedPassword authToken:(NSString * _Nullable)authToken email:(NSString * _Nullable)email policyID:(NSString * _Nullable)policyID signingInWithSAML:(NSNumber *)signingInWithSAML {
