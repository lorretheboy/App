...
export interface Spec extends TurboModule {
    ...
    signInToOldDot: (autoGeneratedLogin: string | null, autoGeneratedPassword: string | null, authToken: string | null, email: string | null, policyID: string | null, signingInWithSAML?: boolean) => void;
