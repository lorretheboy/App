        ...
        stepContent = (
            <View style={[styles.flex1, styles.mb3, styles.ph5]}>
                <View>
                    ...
                    <RenderHTML
                        html={`<muted-text>${translate('workspace.certinia.prerequisites.installBundlePSADescription', {
                ...
                <View style={styles.mt5}>
                    ...
                    <RenderHTML
                        html={`<muted-text>${translate('workspace.certinia.prerequisites.installBundleFFADescription', {
