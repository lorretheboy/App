...
function MoneyRequestReportGroupHeader({
    ...
    const cleanedGroupName = isGroupedByTag && group.groupName ? getCommaSeparatedTagNameWithSanitizedColons(group.groupName) : getDecodedCategoryName(group.groupName);
