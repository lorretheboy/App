 ...
 * Mirrors the selector in the FAB's CreateReportMenuItem so the create-report row appears under the same conditions.
 */
 ...
 * parent-tab label on the right. Mirrors FloatingActionButtonAndPopover's items and their gating,
 * except the contextual Quick action item, which is intentionally excluded.
 */
