...
function SearchBulkActionsButton({queryJSON}: SearchBulkActionsButtonProps) {
    ...
    const selectionButtonText =
        areAllMatchingItemsSelected && allMatchingItemsCount === undefined
            ? translate('search.exportAll.allMatchingItemsSelected')
            : translate('workspace.common.selected', {count: areAllMatchingItemsSelected ? (allMatchingItemsCount ?? 0) : selectedItemsCount});
