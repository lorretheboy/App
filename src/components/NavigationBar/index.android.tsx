...
/** NavigationBar renders an opaque background behind the three-button navigation bar on Android. */
function NavigationBar() {
    ...
    return isSoftKeyNavigation ? <View style={[styles.appBG, styles.stickToBottom, {height: paddingBottom}]} /> : null;
}
